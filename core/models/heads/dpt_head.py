...
class SingleDPTHead(DPTHead):
    def __init__(
        ...
        intermediate_layer_idx: List[int] = [0],
        pos_embed: bool = True,
        feature_only: bool = False,
        down_ratio: int = 1,
    ) -> None:
        ...
        self.scratch = _make_single_scratch(
            out_channels,
            features,
            expand=False,
        )
    ...
    def scratch_forward(self, features: List[torch.Tensor]) -> torch.Tensor:
        ...
        out = self.scratch.refinenet1(layer_1_rn)
        del layer_1_rn, layer_1
