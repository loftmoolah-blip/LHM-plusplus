...
class SerializedAttention(PointModule):
    def __init__(
        ...
        if enable_flash and flash_attn is not None:
            assert (
                enable_rpe is False
    ...
    def get_padding_and_inverse(self, point):
        ...
        if (
            ...
            point["patch_size"] = self.patch_size
    ...
    def forward(self, point):
        ...
        # pad index, unpad index, cuda attention length idx, split by patch_size
...
class PointTransformerV3(PointModule, PyTorchModelHubMixin):
    def __init__(
        ...
        self.decoder_concat_stop_feat = decoder_concat_stop_feat
    ...
    def decoder(self, points, layer_i=0):
        if layer_i < self.decoder_concat_stop_feat:
            ...
            parent = points.pop("pooling_parent")
            inverse = points.pop("pooling_inverse")
            parent.feat = points.feat[inverse]

        return parent, layer_i + 1

    def serialization_sparisy(self, point):

        point = self.embedding(point)
        shuffle_orders = self.shuffle_orders if self.training else False
    ...
    def forward(self, data_dict):
        ...
        # [coord, grid_coord, color, inverse, offset, feat]
...
class PointEmbed(PointModule, PyTorchModelHubMixin):
    def __init__(
        self,
        in_channels=6,
        order=("z", "z-trans"),
        ...
        self.mlp = PointSequential(
            MLP(
                ...
                hidden_channels=int(enc_channels[0] * mlp_ratio),
