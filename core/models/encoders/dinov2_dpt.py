...
# from core.models.encoders.dpt_util.dinov2 import DINOv2
from core.models.encoders.dpt_util.blocks import FeatureFusionBlock, _make_scratch
from core.models.encoders.dpt_util.transform import (
    NormalizeImage,
    PrepareForNet,
    Resize,
)
